...
class handler(BaseHTTPRequestHandler):
  ...
  def do_GET(self):
    ...
    pastCoursesRequestHeaders = {
        "Host": "hac.coppellisd.com",
        "User-Agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:98.0) Gecko/20100101 Firefox/98.0",
        'X-Requested-With': 'XMLHttpRequest',
        "Origin": "https://hac.coppellisd.com",
        "Referer": "https://hac.coppellisd.com/HomeAccess/Content/Student/Assignments.aspx"
    }
    ...
    pastCoursesPageContent = session.post(
        "https://hac.coppellisd.com/HomeAccess/Content/Student/Assignments.aspx",
