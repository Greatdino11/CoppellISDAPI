...
class handler(BaseHTTPRequestHandler):
  ...
  def do_GET(self):
    ...
    registrationPageContent = session.get("https://hac.coppellisd.com/HomeAccess/Content/Student/Registration.aspx").text
    ...
    try:
      ...
      schedulePageContent = session.get("https://hac.coppellisd.com/HomeAccess/Content/Student/Classes.aspx")
